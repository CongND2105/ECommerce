...
<footer class="footer-section">
  <div class="container relative">
    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="subscription-form">
          <h3 class="d-flex align-items-center"><span class="me-1"><img src="/images/envelope-outline.svg" alt="Hình ảnh" class="img-fluid"></span><span>Đăng ký nhận bản tin</span></h3>
    ...
    <div class="border-top copyright">
      <div class="row pt-4">
        <div class="col-lg-6">
          <p class="mb-2 text-center text-lg-start">Bản quyền &copy;<script>document.write(new Date().getFullYear());</script>. Đã đăng ký bản quyền. &mdash; Thiết kế với tình yêu bởi <a href="https://untree.co">Untree.co</a>. Phân phối bởi <a href="https://themewagon.com">ThemeWagon</a>  <!-- Thông tin về giấy phép: https://untree.co/license/ -->
          </p>
        </div>
